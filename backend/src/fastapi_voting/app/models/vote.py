...
class Vote(Base):
    ...
    question: Mapped["Question"] = relationship(back_populates="votes", foreign_keys=[question_id])
    option: Mapped["Option"] = relationship(back_populates="votes", foreign_keys=[option_id])
