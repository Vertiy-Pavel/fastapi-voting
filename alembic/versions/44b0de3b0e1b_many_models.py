...
Revision ID: 44b0de3b0e1b
Revises: a7010edd427e
Create Date: 2025-10-03 12:48:40.672418
...
def upgrade() -> None:
    ...
    op.create_table('registered_user_association',
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('votes')
    op.drop_table('registered_user_association')
